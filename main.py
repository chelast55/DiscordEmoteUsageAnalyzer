...
if __name__ == "__main__":
    ...
    #emote_counter.run(input_directory, output_directory, "emote_usage.csv", include_vanilla_emotes=False)

    # generate .csv file logging emote use of all discord channel text documents in input_directory combined
    emote_counter.run(input_directory, output_directory, "emote_usage.csv", include_vanilla_emotes=True)
